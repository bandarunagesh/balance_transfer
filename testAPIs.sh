...
TRX_ID_N=$(curl -s -X POST \
  ...
  -d '{
	...
	"fcn":"initPatient",
	"args":["1234","nagesh","bandaru","nagesh@outlook.com","11-10-1985","11111","44444"]
}')
...
echo
curl -s -X GET http://localhost:4000/channels/mychannel/transactions/$TRX_ID_N?peer=peer0.org1.example.com \
  -H "authorization: Bearer $ORG1_TOKEN" \
  -H "content-type: application/json"
echo
echo
